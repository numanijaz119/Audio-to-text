...
import { Music, Upload, FileText, Download, Shield, Zap, Globe2 } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Get your transcriptions in seconds, powered by OpenAI Whisper AI',
    },
    {
      icon: <Globe2 className="w-6 h-6" />,
      title: 'Multi-Language',
      description: 'Support for English and Hindi with high accuracy transcription',
    },
    {
  ...
  const steps = [
    {
      ...
      title: 'Upload Audio',
      description: 'Drag and drop your audio file or click to select. We support MP3, WAV, M4A, FLAC, and OGG.',
    },
    {
      number: '02',
      icon: <Music className="w-8 h-8" />,
      title: 'Process',
      description: 'Our AI analyzes your audio and converts speech to text with exceptional accuracy.',
    },
    {
      number: '03',
      icon: <Download className="w-8 h-8" />,
      title: 'Download',
      description: 'Get your transcription as a text file. Copy, edit, or download as needed.',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 mb-8 animate-slide-down">
              ...
              <span className="text-sm font-medium text-blue-700">Powered by OpenAI Whisper</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-slate-500 font-light max-w-2xl mx-auto mb-10 animate-slide-up opacity-0 stagger-2 text-balance">
              Convert your audio files to text in seconds with AI-powered transcription. 
              Simple, fast, and incredibly accurate.
            </p>
          ...
          <div className="mt-16 md:mt-24 relative animate-fade-in opacity-0 stagger-4">
            ...
            <div className="absolute -bottom-10 -right-10 w-72 h-72 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float" style={{ animationDelay: '1s' }} />
            ...
            <div className="relative card-elevated max-w-3xl mx-auto p-8 md:p-12">
              ...
              <div className="mt-6 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <p className="text-slate-700 leading-relaxed">
                  "Welcome to our audio transcription service. This is a sample of how your 
                  transcribed text will appear. The AI processes your audio with remarkable 
                  accuracy, capturing every word..."
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="card-elevated p-12 md:p-16 bg-gradient-to-br from-blue-600 to-blue-700 text-white">
            ...
            <p className="text-xl text-blue-100 font-light mb-8 max-w-xl mx-auto">
              Get 10 free minutes when you sign up. Then pay only ₹1 per minute transcribed.
            </p>
            <button
              onClick={() => setShowLoginModal(true)}
              disabled={isLoading}
